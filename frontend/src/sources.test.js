...
describe("data source groups", () => {
  ...
  it("labels long and stop-long signal details for the dashboard", () => {
    ...
    expect(tradeSignalReason("oi_to_market_cap_in_ambush_zone")).toBe("OI / 市值已高于 200%，禁止开多");
    ...
    expect(tradeSignalReason("quote_volume_not_above_average")).toBe("15m 成交额未突破前20根均量的2倍");
