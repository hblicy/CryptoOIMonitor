...
- 做多：最近 3 根已收盘 15m K 线内至少出现一次收盘价由不高于当时 EMA200 到高于 EMA200 的向上突破，且当前收盘价仍高于当前 EMA200；当前 EMA200 高于 5 根 K 线前的 EMA200；当前 15m USDT 成交额严格高于前 20 根平均成交额的 `1.1` 倍，不再要求高于上一根成交额；RSI(14) 严格低于 60 且高于上一根 RSI，不再设置 RSI 最低值。
